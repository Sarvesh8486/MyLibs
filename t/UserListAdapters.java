...
public class UserListAdapters extends RecyclerView.Adapter<UserListAdapters.UserListAdapterHolders> {
    ...
    public void onItemRemove(final RecyclerView.ViewHolder viewHolder, final RecyclerView recyclerView) {
        final int adapterPosition = Integer.parseInt((String) viewHolder.itemView.getTag());
        final Context context = recyclerView.getContext();
        Log.e("123", "adapterPosition: "+adapterPosition);
        Log.e("123", "onItemRemove: 1 "+cursor.getCount());

        //backup cursor
        final Cursor backupForDeletion = DatabaseQueries.selectNotesById(context, adapterPosition);

        Log.e("123", "onItemRemove: 2 "+backupForDeletion.getCount());

        DatabaseQueries.deleteNote(context, adapterPosition);
